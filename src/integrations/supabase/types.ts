  ...
  public: {
    Tables: {
      ...
      clube_registros: {
        ...
        Relationships: [
          {
            foreignKeyName: "clube_registros_atividade_id_fkey"
            columns: ["atividade_id"]
            isOneToOne: false
            referencedRelation: "clube_atividades"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "clube_registros_membro_id_fkey"
            columns: ["membro_id"]
            isOneToOne: false
            referencedRelation: "clube_membros"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Functions: {
      ...
      fn_rebaixar_nivel_inativo: { Args: never; Returns: undefined }
      get_athos_eventos: {
